...
class CalendarApp(QMainWindow):
    ...
    def show_calendar(self):
        try:
            ...
            #clear the text area before displaying the new calendar
            ...
            #if the input is not a valid year, show an error message
            self.displayCalendar.setText(f"Error: {str(e)}\nPlease enter a valid year.")
            self.displayCalendar.setStyleSheet("font: 14px 'Courier New'; color: red; background-color: lightgray;")
